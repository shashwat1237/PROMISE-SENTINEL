...
- **Correctness over availability**: The system favors data integrity over convenience
...
Demo Flow
Select a product → encrypted data appears instantly

Enable Chaos Mode → network degrades, UI reflects failure

Continue transactions → data queues locally

Disable Chaos Mode → queue flushes automatically
